...
public class GeospatialManager : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        /* 
        This is where the Text for geospatial status is updated
        If you need anything changed for the Geospatial status, just change the text here.
        This is mainly for debugging and UI purposes.
        */
